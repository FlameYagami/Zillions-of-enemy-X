...
namespace DeckEditor.ViewModel
{
    public class DeckOperationVm : BaseModel
    {
        ...
        public DeckOperationVm(DeckExVm deckExVm, PlayerVm playerVm, DeckStatsVm deckStatsVm)
        {
            ...
            CmdDeckDetail = new DelegateCommand {ExecuteCommand = DeckDetail_Click};
        ...
        public DelegateCommand CmdDeckDetail { get; set; }
        ...
        {
            await DialogHost.Show(new DeckDetailDialog(_deckManager));
        }
