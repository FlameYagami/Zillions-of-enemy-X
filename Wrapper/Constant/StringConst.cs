namespace Wrapper.Constant
{
    public class StringConst
    {
        ...
        // Camp
        public const string CampRed = "红";
        public const string CampBlue = "蓝";
        public const string CampWhite = "白";
        public const string CampBlack = "黑";
        public const string CampGreen = "绿";
        public const string CampVoid = "无";

        // Sign
        public const string SignIg = "点燃";
        public const string SignEl = "觉醒之种";

        // Rare
        public const string RarePr = "PR";

        // Ability
        public const string AbilityLv = "Lv";
        public const string AbilityInsulateWards = "【常】绝界";
